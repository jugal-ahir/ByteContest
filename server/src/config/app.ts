...
const corsOptions = {
    origin: function (
        ...
        if (!origin || origin.startsWith("http://localhost") || origin.startsWith("http://10.20.10.111") || origin.startsWith("http://192.168.1.181") || origin.startsWith("http://192.168.1.181:8080")) {
